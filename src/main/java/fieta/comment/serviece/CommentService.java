package fieta.comment.serviece;

import fieta.admin.Admin;
import fieta.admin.AdminRepository;
import fieta.comment.domain.Comment;
import fieta.comment.domain.CommentLike;
import fieta.comment.dto.*;
import fieta.comment.exception.NoExistsEtfIdException;
import fieta.comment.exception.NoExistsUserIdException;
import fieta.comment.repository.CommentLikeRepository;
import fieta.comment.repository.qdto.CommentAndLikesCountQDto;
import fieta.comment.repository.qdto.SortedCommentsQDto;
import fieta.comment.repository.CommentRepository;
import fieta.comment.repository.CommentRepositoryCustom;
import fieta.etf.EtfRepository;
